...
-- Copiando dados para a tabela camila.categories_roles: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela camila.roles: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela camila.session_tokens: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela camila.users: ~0 rows (aproximadamente)
INSERT INTO `users` (`id`, `name`, `email`, `password`, `pic`, `bio`, `phone`, `phone_verified`, `created`) VALUES
	(46, 'dadasd', 'wescleypa.br@gmail.com', 'Badkill1!', NULL, NULL, NULL, NULL, '2025-04-06 18:17:55');
...
-- Copiando dados para a tabela camila.user_config: ~0 rows (aproximadamente)
